...
\begin{itemize}
	...
	\item[$\rightarrow$] The SNR after bias removal is by \glqq 1\grqq\, smaller than the \glqq biased \grqq SNR $\rightarrow$ general result valid for any type of MMSE estimation
...
\begin{itemize}
	...
	\item Blockdiagramm % Blockdiagramm einfuegen
	\item Observations:
	\begin{itemize}
