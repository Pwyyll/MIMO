...
\end{align*}
\begin{itemize}
	\item Instantaneous SNR: \begin{math}\gamma_t = \frac{\epsilon_s}{\sigma_n^2}\times |h|^2  \end{math}
\item Average SNR: \begin{math}\bar{\gamma}_t = \mathcal{E}\{y_t\} = \frac{\epsilon_s}{\sigma_n^2}\end{math}
\end{itemize}
...
\end{itemize}
\begin{align*}
	P_e(y_t) = aQ\bigl\{ \sqrt{b\gamma_t}\bigr\}
\end{align*}
where:
\begin{itemize}
	\item \begin{math} Q(x) = \frac{1}{\sqrt{2\pi}}\times\int_{x}^{\infty} e^{-\frac{t^2}{2}}~dt
	\end{math}
	\item \begin{math}P_e(\gamma_t) \end{math} may be exact or approximation
